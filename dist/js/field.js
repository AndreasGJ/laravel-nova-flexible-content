...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-flexible-content', __webpack_require__(44));
    Vue.component('detail-flexible-content', __webpack_require__(47));
    Vue.component('form-flexible-content', __webpack_require__(50));
});
...
exports.default = {
  ...
  data: function data() {
    var _field = this.field,
        value = _field.value,
        _field$layouts = _field.layouts,
        layouts = _field$layouts === undefined ? [] : _field$layouts;

    var itemValues = value ? JSON.parse(value) : [];

    var rows = [];
    itemValues.forEach(function (_ref) {
      var type = _ref.type,
          _ref$data = _ref.data,
      ...
      rows.push((0, _extends3.default)({}, l, {
        fields: l.fields.map(function (b) {
...
var render = function() {
  ...
  return _c("span", [
    _vm._v(
      _vm._s(
        _vm.field.value && _vm.rows.length > 0
          ? "Content count: " + _vm.rows.length
          : "-"
      )
    )
  ])
...
var update = __webpack_require__(3)("e5d016e6", content, false, {});
...
var _LayoutList = __webpack_require__(88);

var _LayoutList2 = _interopRequireDefault(_LayoutList);

var _LayoutSelector = __webpack_require__(136);

var _LayoutSelector2 = _interopRequireDefault(_LayoutSelector);

var _laravelNova = __webpack_require__(141);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = {
  mixins: [_laravelNova.FormField, _laravelNova.HandlesValidationErrors],
  components: { LayoutSelector: _LayoutSelector2.default, LayoutList: _LayoutList2.default },
  data: function data() {
    return {
      value: "",
      layouts: [],
  ...
  computed: {
    addButtonText: function addButtonText() {
      return this.field.add_button_text ? this.field.add_button_text : "Add new content";
    },
  ...
  methods: {
    handleDirection: function handleDirection(index, dir) {
      var el = this.rows[index];
      var rows = this.rows;
      ...
      if (dir === "up") {
        ...
        var down = rows[index + 1];
        if (down) {
          rows[index + 1] = el;
          rows[index] = down;
        }
      }
      this.rows = [].concat((0, _toConsumableArray3.default)(rows));
    },
    ...
    handleChange: function handleChange(index) {
      var rowData = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      this.rows = this.rows.map(function (x, i) {
        return i === index ? (0, _extends3.default)({}, x, rowData) : x;
      });
    },
    toggleLayouts: function toggleLayouts() {
    ...
    setInitialValue: function setInitialValue() {
      ...
      var layouts = this.field.layouts || [];
      this.layouts = layouts;

      this.$nextTick(function () {
        var itemValues = _this.value ? JSON.parse(_this.value) : [];
  ...
  watch: {
    rows: {
      handler: function handler(newRows) {
        this.value = (0, _stringify2.default)(newRows.map(function (_ref2) {
          var name = _ref2.name,
...
Component.options.__file = "resources/js/components/form/LayoutList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5fa4a790", Component.options)
  } else {
    hotAPI.reload("data-v-5fa4a790", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("03ceae38", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5fa4a790\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./LayoutList.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5fa4a790\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./LayoutList.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var _FlexibleInputImage = __webpack_require__(154);

var _FlexibleInputImage2 = _interopRequireDefault(_FlexibleInputImage);

var _FlexibleInputNormal = __webpack_require__(164);

var _FlexibleInputNormal2 = _interopRequireDefault(_FlexibleInputNormal);

var _FlexibleInputTextarea = __webpack_require__(159);

var _FlexibleInputTextarea2 = _interopRequireDefault(_FlexibleInputTextarea);

var _FlexibleInputSelect = __webpack_require__(169);

var _FlexibleInputSelect2 = _interopRequireDefault(_FlexibleInputSelect);

var _FlexibleInputTrix = __webpack_require__(149);

var _FlexibleInputTrix2 = _interopRequireDefault(_FlexibleInputTrix);

var _FlexibleInputResource = __webpack_require__(199);

var _FlexibleInputResource2 = _interopRequireDefault(_FlexibleInputResource);
...
exports.default = {
  name: "layout-list",
  components: {
    InputImage: _FlexibleInputImage2.default,
    InputNormal: _FlexibleInputNormal2.default,
    InputTextarea: _FlexibleInputTextarea2.default,
    InputTrix: _FlexibleInputTrix2.default,
    InputSelect: _FlexibleInputSelect2.default,
    InputResource: _FlexibleInputResource2.default
  },
  props: ["rows", "onDelete", "onChange", "onDirection"],

  methods: {
    showField: function showField(field, row) {
      var ifLogic = field.if;
      var _row$fields = row.fields,
          fields = _row$fields === undefined ? [] : _row$fields;

      if (ifLogic && (typeof ifLogic === "undefined" ? "undefined" : (0, _typeof3.default)(ifLogic)) === "object") {
        return (0, _keys2.default)(ifLogic).some(function (k) {
          var v = ifLogic[k];
          var field = fields.find(function (x) {
            return x.name === k;
          });

          if (field && field.value && (field.value === v || field.value.indexOf(v) >= 0)) {
            return true;
          }
          return false;
        });
    ...
    handleChange: function handleChange(rowIndex, fieldIndex) {
      var _this = this;

      var row = this.rows[rowIndex];

      return function (value) {
        return _this.onChange(rowIndex, (0, _extends3.default)({}, row, {
          fields: row.fields.map(function (f, fi) {
            return fieldIndex === fi ? (0, _extends3.default)({}, f, { value: value }) : f;
          })
        }));
      };
    }
...
var render = function() {
  ...
  return _vm.rows && _vm.rows.length > 0
    ? _c("div", [
        _c(
          "ul",
          { staticClass: "layout-list" },
          _vm._l(_vm.rows, function(row, rowIndex) {
            return _c(
              "li",
              { key: row.name, staticClass: "layout-list__item layout-item" },
              [
                _c("h4", { staticClass: "layout-item__title" }, [
                  _vm._v("\n        " + _vm._s(row.label) + "\n        "),
                  _c(
                    "button",
                    {
                      staticClass: "btn btn-default btn-up",
                      class: { deactivated: 0 === rowIndex },
                      on: {
                        click: function($event) {
                          $event.preventDefault()
                          return _vm.onDirection(rowIndex, "up")
                        }
                      }
                    },
                    [_vm._v("Up")]
                  ...
                  _c(
                    "button",
                    {
                      staticClass: "btn btn-default btn-down",
                      class: { deactivated: _vm.rows.length - 1 === rowIndex },
                      on: {
                        click: function($event) {
                          $event.preventDefault()
                          return _vm.onDirection(rowIndex, "down")
                        }
                      }
                    },
                    [_vm._v("Down")]
                ...
                _c(
                  ...
                  {
                    class:
                      "layout-item__fields" + (row.class ? " " + row.class : "")
                  },
                  _vm._l(
                    row.fields.filter(function(f) {
                      return _vm.showField(f, row)
                    }),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5fa4a790", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/form/LayoutSelector.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0198d40e", Component.options)
  } else {
    hotAPI.reload("data-v-0198d40e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("5e0f5326", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0198d40e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./LayoutSelector.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0198d40e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./LayoutSelector.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
        ...
        _vm._l(_vm.layouts, function(layout) {
          return _c(
            "li",
            {
              ...
              on: {
                click: function($event) {
                  return _vm.onClick(layout)
                }
              }
            },
            [_vm._v(_vm._s(layout.label))]
          )
        }),
        0
      )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0198d40e", module.exports)
  }
}
    ...
    _c(
      ...
      [
        _c("layout-list", {
          attrs: {
            rows: _vm.rows,
            onDelete: _vm.deleteRow,
            onChange: _vm.handleChange,
            onDirection: _vm.handleDirection
          }
        }),
        _vm._v(" "),
        _c("layout-selector", {
          attrs: {
            show: _vm.showLayouts,
            layouts: _vm.layouts,
        ...
        _c("button", {
          ...
          class: { "cursor-not-allowed opacity-50": _vm.hasReachedMaximumRows },
          domProps: { textContent: _vm._s(_vm.addButtonText) },
          on: {
            click: function($event) {
              $event.preventDefault()
              return _vm.toggleLayouts($event)
            }
          }
        })
      ],
...
Component.options.__file = "resources/js/components/form/fields/FlexibleInputTrix.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-13d37474", Component.options)
  } else {
    hotAPI.reload("data-v-13d37474", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("21901f60", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-13d37474\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputTrix.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-13d37474\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputTrix.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
  ...
  methods: {
    ...
    handleChange: function handleChange(evt) {
      var id = this.id;
      var newValue = this.$refs[id].value;
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "flexible-input-container input-trix" },
    [
      _c("label", { staticClass: "input-label", attrs: { for: _vm.id } }, [
        _vm._v("\n    " + _vm._s(_vm.data.label) + "\n    "),
        _vm.data.required === true
          ? _c("span", { staticClass: "input-label__required" }, [_vm._v("*")])
          : _vm._e()
      ]),
      _vm._v(" "),
      _c("trix-editor", {
        ...
        attrs: {
          ...
          required: _vm.data.required === true
        },
        on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-13d37474", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/form/fields/FlexibleInputImage.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b5e42ddc", Component.options)
  } else {
    hotAPI.reload("data-v-b5e42ddc", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("4044f374", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b5e42ddc\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputImage.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b5e42ddc\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputImage.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.input-file {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: row;\n          flex-direction: row;\n  -webkit-box-pack: start;\n      -ms-flex-pack: start;\n          justify-content: flex-start;\n  -webkit-box-align: start;\n      -ms-flex-align: start;\n          align-items: flex-start;\n}\n.input-file__input-field {\n    padding: 10px;\n    margin: 10px 15px 0 0;\n    text-align: center;\n    background: #cccccc;\n    border-radius: 50%;\n    height: 120px;\n    width: 120px;\n    -ms-flex-negative: 0;\n        flex-shrink: 0;\n    position: relative;\n    overflow: hidden;\n    -ms-flex-item-align: start;\n        align-self: flex-start;\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n        -ms-flex-direction: column;\n            flex-direction: column;\n    -webkit-box-pack: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n}\n.input-file__input-field label {\n      display: block;\n      margin: 0 0 7px;\n      background: none !important;\n}\n.input-file__input {\n    margin: 10px 0;\n    cursor: pointer;\n    opacity: 0;\n    position: absolute;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 100%;\n    z-index: 10;\n}\n.input-file__values {\n    -webkit-box-flex: 1;\n        -ms-flex-positive: 1;\n            flex-grow: 1;\n    padding: 15px;\n    min-width: 50%;\n}\n.input-file__values img {\n      max-width: 100%;\n      max-height: 150px;\n}\n.input-file__values.uploading {\n      background: #eee;\n}\n.input-file__values.uploading img {\n        max-height: 100px;\n}\n.input-file__gallery {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-flex: 1;\n        -ms-flex-positive: 1;\n            flex-grow: 1;\n    -webkit-box-orient: horizontal;\n    -webkit-box-direction: normal;\n        -ms-flex-direction: row;\n            flex-direction: row;\n    -webkit-box-pack: start;\n        -ms-flex-pack: start;\n            justify-content: flex-start;\n    -webkit-box-align: stretch;\n        -ms-flex-align: stretch;\n            align-items: stretch;\n    -ms-flex-wrap: wrap;\n        flex-wrap: wrap;\n}\n.input-file__gallery__item {\n      display: -webkit-box;\n      display: -ms-flexbox;\n      display: flex;\n      -webkit-box-orient: vertical;\n      -webkit-box-direction: normal;\n          -ms-flex-direction: column;\n              flex-direction: column;\n      -webkit-box-pack: start;\n          -ms-flex-pack: start;\n              justify-content: flex-start;\n      -webkit-box-align: start;\n          -ms-flex-align: start;\n              align-items: flex-start;\n      width: 25%;\n      margin: 5px;\n      background: #ccc;\n}\n.input-file__gallery__item__actions {\n        display: -webkit-box;\n        display: -ms-flexbox;\n        display: flex;\n        -webkit-box-orient: horizontal;\n        -webkit-box-direction: normal;\n            -ms-flex-direction: row;\n                flex-direction: row;\n        -webkit-box-pack: justify;\n            -ms-flex-pack: justify;\n                justify-content: space-between;\n        -webkit-box-align: center;\n            -ms-flex-align: center;\n                align-items: center;\n        background: #313131;\n        padding: 5px;\n        text-align: right;\n        margin: auto 0 0 0;\n        width: 100%;\n}\n.input-file__gallery__item__actions button {\n          font-size: 11px;\n          line-height: 16px;\n          color: #ffffff;\n          padding: 0;\n          margin: 0 5px;\n}\n.input-file__gallery__item__actions .btn-delete {\n          color: #e74444;\n          font-weight: bold;\n}\n.input-file__gallery__item:first-child .btn-order-up {\n        opacity: 0;\n}\n.input-file__gallery__item:last-child .btn-order-down {\n        opacity: 0;\n}\n", ""]);
...
exports.default = {
  ...
  methods: {
    ...
    handleDirection: function handleDirection(index, dir) {
      ...
      var img = isValue ? this.data.value[index] : this.images[index];

      var images = isValue ? this.data.value : this.images;
      if (dir == "up") {
        var up = images[index - 1];
        if (up) {
          images[index - 1] = img;
          images[index] = up;
        }
      } else {
        var down = images[index + 1];
        if (down) {
          images[index + 1] = img;
          images[index] = down;
        }
      ...
      if (isValue) {
        ...
        this.images = [].concat((0, _toConsumableArray3.default)(images));
      }
    },
    handleDeleteImage: function handleDeleteImage(index) {
      ...
      if (isValue) {
        this.onChange(this.data.value.filter(function (__, i) {
          return i !== index;
        }));
      } else {
        this.images = this.images.filter(function (__, i) {
          return i !== index;
        });
      }
    },
    uploadImages: function uploadImages() {
      ...
      var _data = this.data,
          ...
          multiple = _data$multiple === undefined ? false : _data$multiple;
      ...
      _axios2.default.post("/nova-vendor/flexible-content/upload-files", form).then(function (_ref) {
        ...
        if (data && data.status && data.fileurls) {
          ...
          if (oldValue && !multiple) {
            _axios2.default.post("/nova-vendor/flexible-content/delete-files", {
              fileurls: typeof oldValue === "string" ? [oldValue] : oldValue
            });
          }
          _this.onChange(multiple ? oldValue ? [].concat((0, _toConsumableArray3.default)(oldValue), (0, _toConsumableArray3.default)(data.fileurls)) : data.fileurls : data.fileurls[0]);
        }
      });
    },
    handleChange: function handleChange(files) {
      ...
      var _data$multiple2 = this.data.multiple,
          multiple = _data$multiple2 === undefined ? false : _data$multiple2;

      var save = this.onChange;
      this.files = files;
        ...
        if (multiple) {
          ...
          var _loop = function _loop(i) {
            ...
            reader.onload = function (e) {
              ...
              _this2.images = [].concat((0, _toConsumableArray3.default)(_this2.images), [{ src: img, file: i }]);
            };
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "flexible-input-container input-file" }, [
    _c("div", { staticClass: "input-file__input-field" }, [
      _c("label", { staticClass: "input-label", attrs: { for: _vm.id } }, [
        _vm._v("\n      " + _vm._s(_vm.data.label) + "\n      "),
        _vm.data.required === true
          ? _c("span", { staticClass: "input-label__required" }, [_vm._v("*")])
      ...
      _vm._v(" "),
      _c("input", {
        staticClass: "input-file__input",
        attrs: {
          id: _vm.id,
          type: "file",
          multiple: _vm.data.multiple ? true : false,
          required: _vm.data.required === true && !_vm.data.value
        },
        on: {
    ...
    _vm._v(" "),
    _vm.images.length > 0
      ? _c("div", { staticClass: "input-file__values uploading" }, [
          !_vm.data.multiple
            ? _c("div", { staticClass: "input-file__single" }, [
                _c("img", { attrs: { src: _vm.images[0].src } })
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.data.multiple
            ? _c(
                "div",
                { staticClass: "input-file__gallery" },
                _vm._l(_vm.images, function(image, index) {
                  return _c(
                    "div",
                    { key: index, staticClass: "input-file__gallery__item" },
                    [
                      _c("img", { attrs: { src: image.src } }),
                      _vm._v(" "),
                      _c(
                        "div",
                        { staticClass: "input-file__gallery__item__actions" },
                        [
                          _c(
                            "button",
                            {
                              staticClass: "btn-order-up",
                              on: {
                                click: function($event) {
                                  $event.preventDefault()
                                  return _vm.handleDirection(index, "up")
                                }
                              }
                            },
                            [_vm._v("Left")]
                          ...
                          _c(
                            "button",
                            {
                              staticClass: "btn-order-down",
                              on: {
                                click: function($event) {
                                  $event.preventDefault()
                                  return _vm.handleDirection(index, "down")
                                }
                              }
                            },
                            [_vm._v("Right")]
    ...
    _vm._v(" "),
    _vm.data.value
      ? _c("div", { staticClass: "input-file__values" }, [
          !_vm.data.multiple
            ? _c("div", { staticClass: "input-file__single" }, [
                _c("img", { attrs: { src: _vm.data.value } })
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.data.multiple
            ? _c(
                "div",
                { staticClass: "input-file__gallery" },
                _vm._l(_vm.data.value, function(image, index) {
                  return _c(
                    "div",
                    { key: index, staticClass: "input-file__gallery__item" },
                    [
                          ...
                          _c(
                            "button",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  $event.preventDefault()
                                  return _vm.handleDirection(index, "up", true)
                                }
                              }
                            },
                            [_vm._v("Left")]
                          ...
                          _c(
                            "button",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  $event.preventDefault()
                                  return _vm.handleDeleteImage(index, true)
                                }
                              }
                            },
                            [_vm._v("Remove")]
          ...
          _c(
            ...
            [_vm._v(_vm._s(_vm.data.multiple ? "Remove all" : "Remove"))]
          )
        ])
      : _vm._e()
  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b5e42ddc", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/form/fields/FlexibleInputTextarea.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-04c491d3", Component.options)
  } else {
    hotAPI.reload("data-v-04c491d3", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("3b0a8b2a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-04c491d3\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputTextarea.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-04c491d3\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputTextarea.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "flexible-input-container input-textarea" }, [
    _c("label", { staticClass: "input-label", attrs: { for: _vm.id } }, [
      _vm._v("\n    " + _vm._s(_vm.data.label) + "\n    "),
      _vm.data.required === true
        ? _c("span", { staticClass: "input-label__required" }, [_vm._v("*")])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-04c491d3", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/form/fields/FlexibleInputNormal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0a764540", Component.options)
  } else {
    hotAPI.reload("data-v-0a764540", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("3c7e2076", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0a764540\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputNormal.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0a764540\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputNormal.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.input-control {\n  -webkit-box-flex: 1;\n      -ms-flex-positive: 1;\n          flex-grow: 1;\n}\n.input-control__container {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: horizontal;\n    -webkit-box-direction: normal;\n        -ms-flex-direction: row;\n            flex-direction: row;\n    -webkit-box-pack: start;\n        -ms-flex-pack: start;\n            justify-content: flex-start;\n    -webkit-box-align: stretch;\n        -ms-flex-align: stretch;\n            align-items: stretch;\n}\n.input-control__container.has-adornment-start .input-control {\n      border-top-left-radius: 0px;\n      border-bottom-left-radius: 0px;\n}\n.input-control__container.has-adornment-end .input-control {\n      border-top-right-radius: 0px;\n      border-bottom-right-radius: 0px;\n}\n.input-control__adornment {\n    background: #bacad6;\n    color: #ffffff;\n    border-radius: 3px 0 0 3px;\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-pack: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n    padding: 0 10px;\n}\n", ""]);
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "flexible-input-container" }, [
    _c("label", { staticClass: "input-label", attrs: { for: _vm.id } }, [
      _vm._v("\n    " + _vm._s(_vm.data.label) + "\n    "),
      _vm.data.required === true
        ? _c("span", { staticClass: "input-label__required" }, [_vm._v("*")])
    ...
    _c(
      "div",
      {
        staticClass: "input-control__container",
        class: {
          "has-adornment-start": _vm.data.adornment_start,
          "has-adornment-end": _vm.data.adornment_end
        }
      },
      [
        _vm.data.adornment_start
          ? _c(
              "span",
              { staticClass: "input-control__adornment adornment-start" },
              [_vm._v(_vm._s(_vm.data.adornment_start))]
            )
          : _vm._e(),
        _vm._v(" "),
        _c("input", {
        ...
        _vm._v(" "),
        _vm.data.adornment_end
          ? _c(
              "span",
              { staticClass: "input-control__adornment adornment-end" },
              [_vm._v(_vm._s(_vm.data.adornment_end))]
            )
          : _vm._e()
      ]
    )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0a764540", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/form/fields/FlexibleInputSelect.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1acaaa56", Component.options)
  } else {
    hotAPI.reload("data-v-1acaaa56", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("3e34b4c2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1acaaa56\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputSelect.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1acaaa56\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputSelect.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
  ...
  methods: {
    handleChange: function handleChange(evt) {
      var _data$multiple = this.data.multiple,
          multiple = _data$multiple === undefined ? false : _data$multiple;
...
var render = function() {
  ...
  return _c("div", { staticClass: "flexible-input-container" }, [
    ...
    _c(
      "select",
      {
        staticClass: "input-select input-control",
        attrs: {
          id: _vm.id,
          multiple: _vm.data.multiple === true,
          required: _vm.data.required === true
        },
        on: {
          change: function($event) {
        ...
        _vm.data.placeholder
          ? _c(
              "option",
              {
                attrs: { value: "" },
                domProps: {
                  selected: !_vm.data.value && !_vm.data.default_value
                }
              },
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm._l(_vm.data.options, function(option, optionV) {
          return _c(
            "option",
            {
              key: optionV,
              domProps: {
                ...
                selected:
                  (_vm.data.value &&
                    _vm.data.multiple &&
                    _vm.data.value.indexOf(optionV) >= 0) ||
                  _vm.data.value == optionV
              }
            },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1acaaa56", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/form/fields/FlexibleInputResource.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-650214a7", Component.options)
  } else {
    hotAPI.reload("data-v-650214a7", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("100b4b51", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-650214a7\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputResource.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-650214a7\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FlexibleInputResource.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
  ...
  data: function data() {
    var _data = this.data,
        ...
        resource_endpoint = _data.resource_endpoint,
        value = _data.resource_value,
        label = _data.resource_label;


    return {
      loading: false,
      showOptions: false,
      options: resource_endpoint ? [] : options.map(function (x) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "flexible-input-container" }, [
    ...
    _c(
      "select",
      {
        staticClass: "input-resource input-control",
        attrs: {
          id: _vm.id,
          multiple: _vm.data.multiple === true,
          required: _vm.data.required === true
            ...
            "option",
            {
              ...
              domProps: {
                ...
                selected:
                  (_vm.data.value &&
                    _vm.data.multiple &&
                    _vm.data.value.indexOf(option.value) >= 0) ||
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-650214a7", module.exports)
  }
}
